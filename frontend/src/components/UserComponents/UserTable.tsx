                        ...
                        {users.length === 0 ? (
                            ...
                            users.map((user, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span
                                            className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getRoleStyle(
                                                user.role
                                            )}`}
                                        >
                                            {user.role}
                                    ...
                                    <td
                                        ...
                                        title={`Home: ${user.address} | Shipping: ${user.shipping_address}`}
                                    >
                                        <div className="truncate">
                                            {user.address}
                                        </div>
                                        <div className="text-xs text-gray-400 truncate">
                                            Ship: {user.shipping_address}
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <span
                                            className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getBalanceStyle(
                                                user.balance
                                            )}`}
                                        >
