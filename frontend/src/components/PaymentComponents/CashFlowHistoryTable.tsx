...
const CashFlowHistoryTable: React.FC<CashFlowHistoryTableProps> = ({
    user,
    cashFlows,
    onRemove,
}) => {
    const getTipeBadge = (tipe: PaymentType) => {
        ...
        return (
            <span
                className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-md ${style}`}
            >
                {tipe}
            </span>
        );
        ...
        <div className="space-y-4">
            <div className="pt-4">
                ...
                <p className="text-gray-500 text-sm mt-1">
                    Riwayat transaksi keuangan untuk "{user.name}"
                </p>
            </div>
