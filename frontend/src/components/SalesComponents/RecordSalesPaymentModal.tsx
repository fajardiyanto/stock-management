...
import { PaymentResponse, CreatePaymentReqeust, CreatePaymentSalesRequest } from '../../types/payment';
...
const RecordSalesPaymentModal: React.FC<RecordSalesPaymentModalProps> = ({ sale, payments, error, onClose, onRefresh }) => {
    ...
    const calculation = useMemo(() => {
        ...
        const percentage = sale.total_amount > 0 ? (paidAfter / sale.total_amount) * 100 : 0;
    ...
    }, [remainingBefore, rawPaymentAmount, sale.paid_amount, sale.total_amount]);
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 border p-4 rounded-xl bg-gray-50">
                            <SummaryBox label="Total Pembelian" value={formatRupiah(sale.total_amount)} />
