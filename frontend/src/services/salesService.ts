...
export const salesService = {
    createSales: async (data: SubmitSaleRequest): Promise<ApiResponse<any>> => {
        const response = await apiCall<ApiResponse<any>>(`/sales`, {
            method: "POST",
            headers: {
    ...
    getAllSales: async (
        filters: SaleFilter = {}
    ): Promise<ApiResponse<SalePaginationResponse>> => {
    ...
    deleteSale: async (saleId: string): Promise<ApiResponse<any>> => {
        const response = await apiCall<ApiResponse<any>>(`/sales/${saleId}`, {
            method: "DELETE",
        });
        return response;
    },
    ...
    updateSales: async (
        id: string,
        data: SubmitSaleRequest
    ): Promise<ApiResponse<any>> => {
        const response = await apiCall<ApiResponse<any>>(`/sales/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
